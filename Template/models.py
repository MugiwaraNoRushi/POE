...
class Master_Section(models.Model):
    ...
    template = models.ForeignKey('Master_Template',on_delete = models.CASCADE, null =True)
...
class Template_Section(models.Model):
    section = models.ForeignKey('Master_Section',on_delete = models.CASCADE,null =True)
